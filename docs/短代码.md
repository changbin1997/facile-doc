...
![facile提示框短代码](./public/shortcode-alert.png)
...
![Facile链接按钮短代码](./public/shortcode-btn.png)
...
![Facile折叠框短代码](./public/shortcode-collapse.gif)
...
![Facile并排显示](./public/shortcode-row.png)
...
![Facile徽章短代码](./public/shortcode-badge.png)
...
![Facile隐藏内容短代码](./public/shortcode-hide.png)
...
![Facile进度条短代码](./public/shortcode-progress.png)
...
![Facile选项卡短代码](./public/shortcode-tab1.gif)

外层是 `tabs` ，标签页用 `tab` ，`title` 是标题，内容包裹在标签页中间。
...
![Facile在选项卡内插入列表和按钮](./public/shortcode-tab2.gif)
